...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/images/og.jpg", width: 1200, height: 630, alt: "Venturis Realtors - Luxury Real Estate" }],
    locale: "en_US",
    type: "website",
  },
  twitter: {
    ...
    title: "Venturis Realtors | Luxury Real Estate",
    description: "Elevating Real Estate to an Art Form. Discover exceptional properties worldwide.",
    images: ["/images/og.jpg"],
    creator: "@venturisrealtors",
    site: "@venturisrealtors",
  },
  robots: { index: true, follow: true, googleBot: { index: true, follow: true, "max-video-preview": -1, "max-image-preview": "large", "max-snippet": -1 } },
  alternates: { canonical: "https://venturisrealtors.com" },
...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  const jsonLd = {
    ...
    address: { "@type": "PostalAddress", streetAddress: "789 Luxury Avenue, Suite 1200", addressLocality: "Beverly Hills", addressRegion: "CA", postalCode: "90210", addressCountry: "US" },
  ...
  return (
    <html lang="en" className={`${playfair.variable} ${inter.variable} antialiased`}>
      ...
      <body className="min-h-screen bg-[#0B0B0C] text-[#B8BDC7] font-body">
        <Header />
